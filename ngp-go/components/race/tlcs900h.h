...
#define XIZ		18
#define XSP		19
#define TLCS_REG_PC	20
#define TLCS_REG_SR	21
#define XSSP	22
#define XNSP	23
...
#ifdef FRAMESKIP
/* cycles <= 0 runs to the next completed video frame. drawFrame controls
 * rendering only; CPU, timers and sound always advance. */
void tlcs_execute(int cycles, int drawFrame);
#else
