...
#ifndef TLCS_MEMORY_HOT_ATTR
#define TLCS_MEMORY_HOT_ATTR
#endif
...
static TLCS_MEMORY_HOT_ATTR INLINE unsigned char tlcsMemReadB(unsigned int addr)
{
	addr&= 0x00FFFFFF;
...
static TLCS_MEMORY_HOT_ATTR INLINE void tlcsMemWriteB(unsigned int addr, unsigned char data)
{
   addr&= 0x00FFFFFF;
   if (addr<0x000008a0)
   {
