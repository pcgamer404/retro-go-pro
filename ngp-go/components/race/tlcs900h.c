...
#include "tlcs900h.h"
#define TLCS_MEMORY_HOT_ATTR IRAM_ATTR
#include "race-memory.h"
#undef TLCS_MEMORY_HOT_ATTR
#include "ngpBios.h"
#include "types.h"
...
int IRAM_ATTR ldirw(void) // LDIRW (XDE+),(XHL+) 10010011 00010001
...
DRAM_ATTR const unsigned short power2[16] =
    {
...
int IRAM_ATTR jrcc6(void)  // JR cc,$+2+d8   0110cccc xxxxxxxx
{
    if (cond6())
    {
        doJumpByte();
...
int IRAM_ATTR jrcc7(void)  // JR cc,$+2+d8   0110cccc xxxxxxxx
{
    if (cond7())
    {
        doJumpByte();
...
typedef int (*decode_handler_t)(void);
/* These tables are touched for every decoded instruction. Keeping them in
 * internal DRAM avoids a flash-cache data access in the interpreter's
 * hottest indirect-dispatch path. */
#define DECODE_TABLE static DRAM_ATTR const decode_handler_t

// instructions where the highest bit of the first byte is set to 1
// x0000xxx xxxxxxxx
DECODE_TABLE decode_table80[256] =
    {
...
// x0010xxx xxxxxxxx
DECODE_TABLE decode_table90[256] =
    {
...
// x0011xxx xxxxxxxx
DECODE_TABLE decode_table98[256] =
    {
        udef,  udef,  udef,  udef,  pushwM10, udef,  udef,  udef,
        udef,  udef,  udef,  udef,  udef,  udef,  udef,  udef,
        udef,  udef,  udef,  udef,  udef,  udef,  udef,  udef,
...
// x0100xxx xxxxxxxx
DECODE_TABLE decode_tableA0[256] =
    {
        udef,  udef,  udef,  udef,  udef,  udef,  udef,  udef,
        udef,  udef,  udef,  udef,  udef,  udef,  udef,  udef,
        udef,  udef,  udef,  udef,  udef,  udef,  udef,  udef,
...
// x0110xxx xxxxxxxx
DECODE_TABLE decode_tableB0[256] =
    {
...
// x0111xxx xxxxxxxx
DECODE_TABLE decode_tableB8[256] =
    {
        ldMI30,  udef,  ldwMI30, udef,  popM30,  udef,  popwM30, udef,
        udef,  udef,  udef,  udef,  udef,  udef,  udef,  udef,
        udef,  udef,  udef,  udef,  ldM1630, udef,  ldwM1630, udef,
...
// x1000xxx xxxxxxxx
DECODE_TABLE decode_tableC0[256] =
    {
        udef,  udef,  udef,  udef,  pushM00, udef,  rld00,  rrd00,
        udef,  udef,  udef,  udef,  udef,  udef,  udef,  udef,
        udef,  udef,  udef,  udef,  udef,  udef,  udef,  udef,
...
// x1001xxx xxxxxxxx
DECODE_TABLE decode_tableC8[256] =
    {
...
// x1010xxx xxxxxxxx
DECODE_TABLE decode_tableD0[256] =
    {
        udef,  udef,  udef,  udef,  pushwM10, udef,  udef,  udef,
        udef,  udef,  udef,  udef,  udef,  udef,  udef,  udef,
        udef,  udef,  udef,  udef,  udef,  udef,  udef,  udef,
...
// x1011xxx xxxxxxxx
DECODE_TABLE decode_tableD8[256] =
    {
...
// x1100xxx xxxxxxxx
DECODE_TABLE decode_tableE0[256] =
    {
        udef,  udef,  udef,  udef,  udef,  udef,  udef,  udef,
        udef,  udef,  udef,  udef,  udef,  udef,  udef,  udef,
        udef,  udef,  udef,  udef,  udef,  udef,  udef,  udef,
...
// x1101xxx xxxxxxxx
DECODE_TABLE decode_tableE8[256] =
    {
...
// x1110xxx xxxxxxxx
DECODE_TABLE decode_tableF0[256] =
    {
        //00
        ldMI30,  udef,  ldwMI30, udef,  popM30,  udef,  popwM30, udef,
        udef,  udef,  udef,  udef,  udef,  udef,  udef,  udef,
...
int IRAM_ATTR decode80(void)  // (XWA) (XBC) (XDE) (XHL) (XIX) (XIY) (XIZ) (XSP) scr.B
{
    mem = *cregsL[opcode&7];
    memB = mem_readB(mem);
    lastbyte = readbyte();
...
int IRAM_ATTR decode88(void)  // (XWA+d) (XBC+d) (XDE+d) (XHL+d) (XIX+d) (XIY+d) (XIZ+d) (XSP+d) scr.B
{
...
int IRAM_ATTR decode90(void)  // (XWA) (XBC) (XDE) (XHL) (XIX) (XIY) (XIZ) (XSP) scr.W
{
    mem = *cregsL[opcode&7];
    memW = mem_readW(mem);
    lastbyte = readbyte();
...
int IRAM_ATTR decode98(void)  // (XWA+d) (XBC+d) (XDE+d) (XHL+d) (XIX+d) (XIY+d) (XIZ+d) (XSP+d) scr.W
{
    mem = (*cregsL[opcode&7])+(signed char)readbyteSetLastbyte();
    memW = mem_readW(mem);
    //lastbyte = readbyte();
...
int IRAM_ATTR decodeA0(void)  // (XWA) (XBC) (XDE) (XHL) (XIX) (XIY) (XIZ) (XSP) scr.L
{
    mem = *cregsL[opcode&7];
    memL = mem_readL(mem);
    lastbyte = readbyte();
...
int IRAM_ATTR decodeA8(void)  // (XWA+d) (XBC+d) (XDE+d) (XHL+d) (XIX+d) (XIY+d) (XIZ+d) (XSP+d) scr.L
{
    mem = (*cregsL[opcode&7])+(signed char)readbyteSetLastbyte();
    memL = mem_readL(mem);
    //lastbyte = readbyte();
...
int IRAM_ATTR decodeB0(void)  // (XWA) (XBC) (XDE) (XHL) (XIX) (XIY) (XIZ) (XSP) dst
{
    mem = *cregsL[opcode&7];
    lastbyte = readbyte();
...
int IRAM_ATTR decodeB8(void)  // (XWA+d) (XBC+d) (XDE+d) (XHL+d) (XIX+d) (XIY+d) (XIZ+d) (XSP+d) dst
{
    mem = (*cregsL[opcode&7])+(signed char)readbyteSetLastbyte();
    //lastbyte = readbyte();
...
int IRAM_ATTR decodeBB(void)  // (XWA+d) (XBC+d) (XDE+d) (XHL+d) (XIX+d) (XIY+d) (XIZ+d) (XSP+d) dst
{
    mem = (*cregsL[opcode&7])+(signed char)readbyteSetLastbyte();
    //lastbyte = readbyte();
    return 2 + decode_tableB8[lastbyte]();
...
int IRAM_ATTR decodeC0(void)  // (n)                scr.B
{
...
int IRAM_ATTR decodeC1(void)  //   (nn)             scr.B
{
...
int IRAM_ATTR decodeC2(void)  //     (nnn)           scr.B
{
...
int IRAM_ATTR decodeC3(void)  //       (mem)         scr.B
{
...
int IRAM_ATTR decodeC4(void)  //         (-xrr)       scr.B
{
...
int IRAM_ATTR decodeC5(void)  //           (xrr+)     scr.B
{
    unsigned char reg = readbyteSetLastbyte();
...
int IRAM_ATTR decodeC7(void)  // r                reg.B
{
...
int IRAM_ATTR decodeC8(void)  // W  A  B  C  D  E  H  L  reg.B
{
...
int IRAM_ATTR decodeD0(void)  // (n)                scr.W
{
    mem = readbyteSetLastbyte();
    memW = mem_readW(mem);
    //lastbyte = readbyte();
    return 2 + decode_table90[lastbyte]();
}

int IRAM_ATTR decodeD1(void)  //   (nn)             scr.W
{
    mem = readwordSetLastbyte();
    memW = mem_readW(mem);
    //lastbyte = readbyte();
...
int IRAM_ATTR decodeD2(void)  //     (nnn)           scr.W
{
    mem = read24SetLastbyte();
    memW = mem_readW(mem);
    //lastbyte = readbyte();
    return 3 + decode_table90[lastbyte]();
}

int IRAM_ATTR decodeD3(void)  //       (mem)         scr.W
{
    unsigned char reg = readbyte();
    signed short d16;
    int    retval = 0;
    ...
    memW = mem_readW(mem);
    lastbyte = readbyte();
    return retval + decode_table90[lastbyte]();
}

int IRAM_ATTR decodeD4(void)  //         (-xrr)       scr.W
{
    unsigned char reg = readbyteSetLastbyte();
...
int IRAM_ATTR decodeD5(void)  //           (xrr+)     scr.W
{
    unsigned char reg = readbyteSetLastbyte();
...
int IRAM_ATTR decodeD7(void)  // r                reg.W
{
...
int IRAM_ATTR decodeD8(void)  // WA  BC  DE  HL  IX  IY  IZ  SP  reg.W
{
...
int IRAM_ATTR decodeE0(void)  // (n)                scr.L
{
    mem = readbyteSetLastbyte();
    memL = mem_readL(mem);
    //lastbyte = readbyte();
...
int IRAM_ATTR decodeE1(void)  //   (nn)             scr.L
{
    mem = readwordSetLastbyte();
    memL = mem_readL(mem);
    //lastbyte = readbyte();
...
int IRAM_ATTR decodeE2(void)  //     (nnn)           scr.L
{
    mem = read24SetLastbyte();
    memL = mem_readL(mem);
    //lastbyte = readbyte();
    return 3 + decode_tableA0[lastbyte]();
}

int IRAM_ATTR decodeE3(void)  //       (mem)         scr.L
{
    unsigned char reg = readbyte();
    signed short d16;
    int    retval = 0;
    ...
    memL = mem_readL(mem);
    lastbyte = readbyte();
    return retval + decode_tableA0[lastbyte]();
}

int IRAM_ATTR decodeE4(void)  //         (-xrr)       scr.L
{
    unsigned char reg = readbyteSetLastbyte();
...
int IRAM_ATTR decodeE5(void)  //           (xrr+)     scr.L
{
    unsigned char reg = readbyteSetLastbyte();
...
int IRAM_ATTR decodeE7(void)  // r                reg.L
{
...
int IRAM_ATTR decodeE8(void)  // XWA  XBC  XDE  XHL  XIX  XIY  XIZ  XSP  reg.L
{
...
int IRAM_ATTR decodeF0(void)  // (n)                dst
{
    mem = readbyteSetLastbyte();
    return 2 + decode_tableB0[lastbyte]();
}

int IRAM_ATTR decodeF1(void)  //   (nn)             dst
{
   mem = readwordSetLastbyte();
   return 2 + decode_tableB0[lastbyte]();
}

int IRAM_ATTR decodeF2(void)  //     (nnn)           dst
{
   mem = read24SetLastbyte();
   return 3 + decode_tableB0[lastbyte]();
}

int IRAM_ATTR decodeF3(void)  //       (mem)         dst
{
   unsigned char reg = readbyte();
   signed short d16;
   int    retval = 0;
   ...
   lastbyte = readbyte();
   return retval + decode_tableB0[lastbyte]();
}

int IRAM_ATTR decodeF4(void)  //         (-xrr)       dst
{
    unsigned char reg;
...
int IRAM_ATTR decodeF5(void)  //           (xrr+)     dst
{
   unsigned char reg;
   int  retval;
   ...
   reg = readbyteSetLastbyte();
   mem = (*allregsL[reg]);
   retval = 3 + decode_tableB0[lastbyte]();
   *allregsL[reg]+= 1<<(reg&3);
   return retval;
}

// main instruction decode table
DRAM_ATTR int (* const instr_table[256])(void) =
{
...
{
    /* tlcs_init() is also the core reset entry point. Keep the tables across
     * resets instead of leaking and reallocating them each time. */
    if (allregsB && allregsW && allregsL &&
        cregsB && cregsW && cregsL && Ztable && SZtable)
        return 0;
...
static int IRAM_ATTR tlcs_step(void)
{
    int clocks = DMAstate;
...
#ifdef FRAMESKIP
void IRAM_ATTR tlcs_execute(int cycles, int drawFrame)
#else
void IRAM_ATTR tlcs_execute(int cycles)
#endif
{
    int elapsed;
    int hCounter = ngOverflow;
    const bool runToFrame = cycles <= 0;
    ...
    do
    {
...
#ifdef FRAMESKIP
            renderThisLine = drawFrame != 0;
#ifdef NGP_HW_INTERLACED
            if (renderThisLine && *scanlineY < 152)
#ifdef NGP_ONLY_RENDER_VISIBLE_LINES
...
#endif
#ifdef NGP_HW_INTERLACED
            if (renderThisLine) // only applied if frame is being rendered
#ifdef NGP_ONLY_RENDER_VISIBLE_LINES
                if (s_lut_y_render[*scanlineY])
#endif
        ...
        cycles -= elapsed;
    } while (runToFrame ? !g_frame_ready : cycles > 0);

    ngOverflow = runToFrame ? hCounter : hCounter + cycles;
}
