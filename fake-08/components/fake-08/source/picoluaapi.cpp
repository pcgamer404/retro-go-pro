...
int tline (lua_State *L){
    ...
    fix32 mx = (int32_t)0, my = (int32_t)0, mdx = fix32::frombits(0x2000), mdy = (int32_t)0;
...
int spr(lua_State *L) {
    ...
    int x = lua_tonumber(L,2);
    int y = lua_tonumber(L,3);
    fix32 w = (fix32)(int32_t)1;
    fix32 h = (fix32)(int32_t)1;
    bool flip_x = false;
    bool flip_y = false;
...
int camera(lua_State *L) {
    ...
    lua_pushnumber(L, (int32_t)get<0>(prev));
    lua_pushnumber(L, (int32_t)get<1>(prev));
...
int clip(lua_State *L) {
    ...
    lua_pushnumber(L, (int32_t)get<0>(prev));
    lua_pushnumber(L, (int32_t)get<1>(prev));
    lua_pushnumber(L, (int32_t)get<2>(prev));
    lua_pushnumber(L, (int32_t)get<3>(prev));
...
int mget(lua_State *L) {
    ...
    lua_pushnumber(L, (int32_t)result);
...
int gfx_map(lua_State *L) {
    ...
    if (celw <= 0) celw = mapW - celx;
    if (celh <= 0) celh = mapH - cely;
...
int btn(lua_State *L){
    ...
    if (numArgs == 0) {
        ...
        lua_pushnumber(L, (int32_t)btnstate);
    }
    else {
...
int btnp(lua_State *L){
    ...
    if (numArgs == 0) {
        ...
        lua_pushnumber(L, (int32_t)btnpstate);
    }
    else {
        fix32 i = lua_tonumber(L,1);
        int p = 0;
...
int time(lua_State *L) {
    ...
    fix32 seconds = (fix32)(int32_t)frameCount / (fix32)(int32_t)targetFps;
...
int stat(lua_State *L) {
    ...
    switch(n){
        ...
        //frame rate
        case 7:
            lua_pushnumber(L, (int32_t)_vmForLuaApi->getFps());
            return 1;
        break;
        //target framerate
        case 8:
        ...
        case 16:
        case 46:
            lua_pushnumber(L, (int32_t)_audioForLuaApi->getCurrentSfxId(0));
            return 1;
        break;
        case 17:
        case 47:
            lua_pushnumber(L, (int32_t)_audioForLuaApi->getCurrentSfxId(1));
            return 1;
        break;
        case 18:
        case 48:
            lua_pushnumber(L, (int32_t)_audioForLuaApi->getCurrentSfxId(2));
            return 1;
        break;
        case 19:
        case 49:
            lua_pushnumber(L, (int32_t)_audioForLuaApi->getCurrentSfxId(3));
            return 1;
        break;
        //20-23 note idx of sfx currently playing
        case 20:
        case 50:
            lua_pushnumber(L, (int32_t)_audioForLuaApi->getCurrentNoteNumber(0));
            return 1;
        break;
        case 21:
        case 51:
            lua_pushnumber(L, (int32_t)_audioForLuaApi->getCurrentNoteNumber(1));
            return 1;
        break;
        case 22:
        case 52:
            lua_pushnumber(L, (int32_t)_audioForLuaApi->getCurrentNoteNumber(2));
            return 1;
        break;
        case 23:
        case 53:
            lua_pushnumber(L, (int32_t)_audioForLuaApi->getCurrentNoteNumber(3));
            return 1;
        break;
        //current music pattern
        case 24:
        case 54:
            lua_pushnumber(L, (int32_t)_audioForLuaApi->getCurrentMusic());
            return 1;
        break;
        //current music count
        case 25:
        case 55:
            lua_pushnumber(L, (int32_t)_audioForLuaApi->getMusicPatternCount());
            return 1;
        break;
        //current music tick count
        case 56:
        case 26:
            lua_pushnumber(L, (int32_t)_audioForLuaApi->getMusicTickCount());
            return 1;
        break;
        ...
        //mouse x
        case 32:
            lua_pushnumber(L, (int32_t)_inputForLuaApi->getMouseX());
            return 1;
        break;
        //mouse y
        case 33:
            lua_pushnumber(L, (int32_t)_inputForLuaApi->getMouseY());
            return 1;
        break;
        //mouse btn state
        case 34:
            lua_pushnumber(L, (int32_t)_inputForLuaApi->getMouseBtnState());
            return 1;
        break;
        //Current Year
        case 90:
            lua_pushnumber(L, (int32_t)_vmForLuaApi->getYear());
            return 1;
        break;
        //Current month
        case 91:
            lua_pushnumber(L, (int32_t)_vmForLuaApi->getMonth());
            return 1;
        break;
        //Current day
        case 92:
            lua_pushnumber(L, (int32_t)_vmForLuaApi->getDay());
            return 1;
        break;
        //Current Hour
        case 93:
            lua_pushnumber(L, (int32_t)_vmForLuaApi->getHour());
            return 1;
        break;
        //Current Minute
        case 94:
            lua_pushnumber(L, (int32_t)_vmForLuaApi->getMinute());
            return 1;
        break;
        //Current second
        case 95:
            lua_pushnumber(L, (int32_t)_vmForLuaApi->getSecond());
            return 1;
        break;
        case 100:
