    ...
    for (size_t i = 0; i < size; ++i){
        ...
        for (int chan = 0; chan < 4; ++chan) {
            ...
            if (channel_state.fade > 0.0f)
            {
                ...
                value = pico8_lerp(value, value_fade, channel_state.fade);
                ...
                chan_reverb1_value = pico8_lerp(chan_reverb1_value, fade_reverb == 1 ? 1.0f : 0.0f, channel_state.fade);
                chan_reverb2_value = pico8_lerp(chan_reverb2_value, fade_reverb == 2 ? 1.0f : 0.0f, channel_state.fade);
                chan_damp1_value = pico8_lerp(chan_damp1_value, fade_dampen == 1 ? 1.0f : 0.0f, channel_state.fade);
                chan_damp2_value = pico8_lerp(chan_damp2_value, fade_dampen == 2 ? 1.0f : 0.0f, channel_state.fade);
            ...
            if (chan_damp2_value > 0.0f) value = pico8_lerp(value, value_damp2, chan_damp2_value);
