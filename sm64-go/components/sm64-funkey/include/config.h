...
// Output render size. Retro-Go scales the submitted surface to the panel.
#ifndef SM64_RENDER_WIDTH
#define SM64_RENDER_WIDTH 160
#endif

#ifndef SM64_RENDER_HEIGHT
#define SM64_RENDER_HEIGHT 120
#endif

// Logical game/UI coordinate space. Keep this at the original SM64 size.
