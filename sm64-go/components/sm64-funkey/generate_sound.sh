...
# Compile the sound player sequence from assembly source
echo "Compiling 00_sound_player.s..."
mkdir -p build/us/sound/sequences
as -I include --defsym VERSION_US=1 -o build/us/sound/sequences/00_sound_player.o sound/sequences/00_sound_player.s
objcopy -j .rodata build/us/sound/sequences/00_sound_player.o -O binary build/us/sound/sequences/00_sound_player.m64
...
python3 tools/assemble_sound.py --sequences build/us/sound/sequences.bin build/us/sound/bank_sets sound/sound_banks/ sound/sequences.json "$SEQ_DIR"/*.m64 build/us/sound/sequences/00_sound_player.m64 -DVERSION_US --endian little --bitwidth 32
