...
public:
	...
	virtual uint32_t SnapshotType() const { return 0; }
	virtual void GetSnapshotState(uint32_t &state0, uint32_t &state1) const
	{
		state0 = (notEXROM ? 1u : 0u) | (notGAME ? 2u : 0u);
		state1 = 0;
	}
	virtual bool SetSnapshotState(uint32_t state0, uint32_t)
	{
		notEXROM = state0 & 1u;
		notGAME = state0 & 2u;
		return true;
...
public:
	...
	uint32_t SnapshotType() const override { return 1; }
};
...
public:
	...
	uint32_t SnapshotType() const override { return 2; }
};
...
public:
	...
	uint32_t SnapshotType() const override { return 3; }
...
public:
	...
	void WriteIO1(uint16_t adr, uint8_t byte) override;
	uint32_t SnapshotType() const override { return 4; }
	void GetSnapshotState(uint32_t &, uint32_t &) const override;
	bool SetSnapshotState(uint32_t, uint32_t) override;
...
public:
	...
	void WriteIO1(uint16_t adr, uint8_t byte) override;
	uint32_t SnapshotType() const override { return 5; }
	void GetSnapshotState(uint32_t &, uint32_t &) const override;
	bool SetSnapshotState(uint32_t, uint32_t) override;
...
public:
	...
	uint32_t SnapshotType() const override { return 6; }
	void GetSnapshotState(uint32_t &, uint32_t &) const override;
	bool SetSnapshotState(uint32_t, uint32_t) override;
...
public:
	...
	uint8_t ReadIO1(uint16_t adr, uint8_t bus_byte) override;
	void WriteIO1(uint16_t adr, uint8_t byte) override;
	uint32_t SnapshotType() const override { return 7; }
	void GetSnapshotState(uint32_t &, uint32_t &) const override;
	bool SetSnapshotState(uint32_t, uint32_t) override;
...
public:
	...
	uint8_t ReadIO1(uint16_t adr, uint8_t bus_byte) override;
	uint32_t SnapshotType() const override { return 8; }
	void GetSnapshotState(uint32_t &, uint32_t &) const override;
	bool SetSnapshotState(uint32_t, uint32_t) override;
...
public:
	...
	uint8_t ReadROML(uint16_t adr, uint8_t ram_byte, bool notLoram) override;
	uint8_t ReadROMH(uint16_t adr, uint8_t ram_byte, uint8_t basic_byte, bool notLoram, bool notHiram) override;
	uint32_t SnapshotType() const override { return 9; }
	void GetSnapshotState(uint32_t &, uint32_t &) const override;
	bool SetSnapshotState(uint32_t, uint32_t) override;
...
public:
	...
	void WriteIO1(uint16_t adr, uint8_t byte) override;
	uint32_t SnapshotType() const override { return 10; }
	void GetSnapshotState(uint32_t &, uint32_t &) const override;
	bool SetSnapshotState(uint32_t, uint32_t) override;
...
public:
	...
	void WriteIO1(uint16_t adr, uint8_t byte) override;
	uint32_t SnapshotType() const override { return 11; }
	void GetSnapshotState(uint32_t &, uint32_t &) const override;
	bool SetSnapshotState(uint32_t, uint32_t) override;
