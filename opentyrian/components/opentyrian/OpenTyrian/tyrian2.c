...
void JE_starShowVGA( void )
{
	...
	{
		// Rendering may be suppressed for a tick, but Retro-Go timing and
		// monitoring must still observe every emulated tick.
		SDL_SkipFlip();
	}
...
level_loop:
	opentyrian_in_gameplay = true;
	SDL_SetAsyncFlip(true);
