...
#define DirectColourMaps (DirectColourMapsPtr)
...
static inline uint16 COLOR_ADD1_2(uint16 C1, uint16 C2)
{
...
static inline uint16 COLOR_SUB1_2(uint16 C1, uint16 C2)
{
