...
struct SCPUState *CPUPtr = NULL;

struct SAPU APU;

struct SIAPU IAPU;

struct SSettings *SettingsPtr = NULL;

struct SDSP1 DSP1;

struct SSA1 *SA1Ptr = NULL;

SSoundData *SoundDataPtr = NULL;
SoundStatus *soPtr = NULL;

SPC7110Regs *s7rPtr = NULL;
SPC7110Decomp *decompPtr = NULL;
double *CosTable2 = NULL;
double *SinTable2 = NULL;
uint8 *SA1_DMABuffer = NULL;
...
struct SPPU *PPUPtr = NULL;
struct InternalPPU *IPPUPtr = NULL;

struct SDMA *DMAPtr = NULL;

uint8 *HDMAMemPointers [8];
uint8 *HDMABasePointers [8];

struct SGFX *GFXPtr = NULL;
...
int32 *Echo = NULL;
int32 *MixBuffer = NULL;
int32 *EchoBuffer = NULL;
int FilterTaps [8];
unsigned long Z = 0;
int Loop [16];
...
struct SRTC_DATA *rtcPtr = NULL;
uint8 (*OBJOnLinePtr)[128] = NULL;

END_EXTERN_C

struct SCheatData *CheatPtr = NULL;

struct SBG BG;
struct SLineData *LineData = NULL;
struct SLineMatrixData *LineMatrixData = NULL;
...
uint16 (*DirectColourMapsPtr) [256] = NULL;
