...
extern struct _TabListData* TabList_Ptr;
#define TabList (*TabList_Ptr)
#else
extern struct _TabListData TabList;
#endif
...
#ifdef CC_BUILD_RETROGO
extern struct NetPlayer* NetPlayers_List;
#else
...
#ifdef CC_BUILD_RETROGO
extern struct LocalPlayer* LocalPlayer_Instances;
#else
