...
static const union { cc_uint64 i; double d; } _DBL_NAN_u = { 0x7FF8000000000000ULL };
#define DBL_NAN  _DBL_NAN_u.d
static const union { cc_uint64 i; double d; } _POS_INF_u = { 0x7FF0000000000000ULL };
#define POS_INF _POS_INF_u.d
