...
extern struct StringsBuffer* Chat_Log_Ptr;
#define Chat_Log (*Chat_Log_Ptr)
extern struct StringsBuffer* Chat_InputLog_Ptr;
#define Chat_InputLog (*Chat_InputLog_Ptr)
#else
