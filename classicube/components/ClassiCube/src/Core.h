...
#define CC_AUD_BACKEND_RETROGO  6
...
/*#define CC_BUILD_GL11*/
	...
	// #define CC_BUILD_NOSOUNDS
	#define CC_BUILD_POSIX
	#define CC_BUILD_MAXSTACK (2 * 1024)
	#define DEFAULT_AUD_BACKEND CC_AUD_BACKEND_RETROGO
	#define DEFAULT_NET_BACKEND CC_NET_BACKEND_BUILTIN
	#define DEFAULT_GFX_BACKEND CC_GFX_BACKEND_SOFTGPU
...
#ifndef CC_RESULT_TYPEDEF
typedef cc_uint32 cc_result;
#define CC_RESULT_TYPEDEF
#endif
