...
static struct CpeExt 
	clickDist_Ext       = { "ClickDistance", 1, 0 },
	customBlocks_Ext    = { "CustomBlocks", 1, 0 },
	heldBlock_Ext       = { "HeldBlock", 1, 0 },  
	emoteFix_Ext        = { "EmoteFix", 1, 0 },
	textHotKey_Ext      = { "TextHotKey", 1, 0 },  
	extPlayerList_Ext   = { "ExtPlayerList", 2, 0 },
	envColors_Ext       = { "EnvColors", 1, 0 },
	selectionCuboid_Ext = { "SelectionCuboid", 1, 0 },
	blockPerms_Ext      = { "BlockPermissions", 1, 0 },
	changeModel_Ext     = { "ChangeModel", 1, 0 },
	mapAppearance_Ext   = { "EnvMapAppearance", 2, 0 },
	weatherType_Ext     = { "EnvWeatherType", 1, 0 },
	messageTypes_Ext    = { "MessageTypes", 1, 0 },
	hackControl_Ext     = { "HackControl", 1, 0 },
	playerClick_Ext     = { "PlayerClick", 1, 0 },
	fullCP437_Ext       = { "FullCP437", 1, 0 },
	longerMessages_Ext  = { "LongerMessages", 1, 0 },
	blockDefs_Ext       = { "BlockDefinitions", 1, 0 },
	blockDefsExt_Ext    = { "BlockDefinitionsExt", 2, 0 },
	bulkBlockUpdate_Ext = { "BulkBlockUpdate", 1, 0 },
	textColors_Ext      = { "TextColors", 1, 0 },
	envMapAspect_Ext    = { "EnvMapAspect", 2, 0 },
	entityProperty_Ext  = { "EntityProperty", 2, 0 },
	extEntityPos_Ext    = { "ExtEntityPositions", 1, 0 },
	twoWayPing_Ext      = { "TwoWayPing", 1, 0 },
	invOrder_Ext        = { "InventoryOrder", 1, 0 },
	instantMOTD_Ext     = { "InstantMOTD", 1, 0 },
	fastMap_Ext         = { "FastMap", 1, 0 },
	setHotbar_Ext       = { "SetHotbar", 1, 0 },
	setSpawnpoint_Ext   = { "SetSpawnpoint", 1, 0 },
	velControl_Ext      = { "VelocityControl", 1, 0 },
	customParticles_Ext = { "CustomParticles", 1, 0 },
	customModels_Ext    = { "CustomModels", 2, 0 },
	pluginMessages_Ext  = { "PluginMessages", 1, 0 },
	extTeleport_Ext     = { "ExtEntityTeleport", 1, 0 },
	lightingMode_Ext    = { "LightingMode", 1, 0 },
	cinematicGui_Ext    = { "CinematicGui", 1, 0 },
	notifyAction_Ext    = { "NotifyAction", 1, 0 },
	toggleBlockList_Ext = { "ToggleBlockList", 1, 0 },
	extTextures_Ext     = { "ExtendedTextures", 1, 0 },
	extBlocks_Ext       = { "ExtendedBlocks", 1, 0 };
...
#include <rg_system.h>
static struct MapState* map1_Ptr;
#define map1 (*map1_Ptr)
#ifdef EXTENDED_BLOCKS
static struct MapState* map2_Ptr;
#define map2 (*map2_Ptr)
#endif
#else
...
#ifdef CC_BUILD_RETROGO
	if (!map1_Ptr) map1_Ptr = (struct MapState*)rg_alloc(sizeof(struct MapState), MEM_SLOW);
#ifdef EXTENDED_BLOCKS
	if (!map2_Ptr) map2_Ptr = (struct MapState*)rg_alloc(sizeof(struct MapState), MEM_SLOW);
#endif
#endif
	MapState_Init(&map1);
#ifdef EXTENDED_BLOCKS
...
static void CPE_CustomBlockLevel(cc_uint8* data) {
	...
	cc_uint8 reply[2] = { OPCODE_CUSTOM_BLOCK_LEVEL, 0 };
