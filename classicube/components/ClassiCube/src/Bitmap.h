...
struct Stream;
	...
	#ifdef BITMAP_565
		#define BitmapCol_G(color) (((cc_uint8)(color >> BITMAPCOLOR_G_SHIFT) & 0x3F) << 2)
	#else
	...
	#ifdef BITMAP_565
		#define BitmapCol_A(color) ((color) ? 255 : 0)
	#else
		#define BitmapCol_A(color) (((cc_uint8)(color >> BITMAPCOLOR_A_SHIFT) & 0x01) ? 255 : 0)
	#endif
	
	/* Converts input value into a packed color component */
	#define BitmapColor_R_Bits(value) (((cc_uint8)(value) >> 3) << BITMAPCOLOR_R_SHIFT)
	#ifdef BITMAP_565
		#define BitmapColor_G_Bits(value) (((cc_uint8)(value) >> 2) << BITMAPCOLOR_G_SHIFT)
	#else
	...
	#ifdef BITMAP_565
		#define BitmapColor_A_Bits(value) 0
	#else
