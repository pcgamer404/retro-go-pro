...
static struct ResourceZipEntry defaultZipEntries[] = {
	/* classic jar files */
	{ "terrain.png",  RESOURCE_TYPE_PNG,  0, {0}, 0, 0 }, { "particles.png",   RESOURCE_TYPE_DATA, 0, {0}, 0, 0 },
	{ "clouds.png",   RESOURCE_TYPE_DATA, 0, {0}, 0, 0 }, { "rain.png",        RESOURCE_TYPE_DATA, 0, {0}, 0, 0 },
	{ "char.png",     RESOURCE_TYPE_DATA, 0, {0}, 0, 0 }, { "default.png",     RESOURCE_TYPE_DATA, 0, {0}, 0, 0 }, 
	{ "icons.png",    RESOURCE_TYPE_DATA, 0, {0}, 0, 0 }, { "gui_classic.png", RESOURCE_TYPE_DATA, 0, {0}, 0, 0 },
	{ "creeper.png",  RESOURCE_TYPE_DATA, 0, {0}, 0, 0 }, { "pig.png",         RESOURCE_TYPE_DATA, 0, {0}, 0, 0 }, 
	{ "sheep.png",    RESOURCE_TYPE_DATA, 0, {0}, 0, 0 }, { "sheep_fur.png",   RESOURCE_TYPE_DATA, 0, {0}, 0, 0 },
	{ "skeleton.png", RESOURCE_TYPE_DATA, 0, {0}, 0, 0 }, { "spider.png",      RESOURCE_TYPE_DATA, 0, {0}, 0, 0 }, 
	{ "zombie.png",   RESOURCE_TYPE_DATA, 0, {0}, 0, 0 },
	/* other files */
	{ "snow.png", RESOURCE_TYPE_DATA, 0, {0}, 0, 0 }, { "chicken.png",    RESOURCE_TYPE_DATA, 0, {0}, 0, 0 },
	{ "gui.png",  RESOURCE_TYPE_DATA, 0, {0}, 0, 0 }, { "animations.png", RESOURCE_TYPE_PNG,  0, {0}, 0, 0 }, 
	{ "animations.txt", RESOURCE_TYPE_CONST, sizeof(ANIMS_TXT) - 1, { (cc_uint8*)ANIMS_TXT }, 0, 0 },
#ifdef CC_BUILD_MOBILE
	{ "touch.png", RESOURCE_TYPE_DATA, 0, {0}, 0, 0 }
#endif
};
...
static struct ZipfileSource defaultZipSources_0030_0023[] = {
	{ "classic jar", "http://launcher.mojang.com/mc/game/c0.30_01c/client/54622801f5ef1bcc1549a842c5b04cb5d5583005/client.jar", ClassicPatcher_ExtractFiles, 291, false, 0 },
	{ "1.6.2 jar",   "http://launcher.mojang.com/mc/game/1.6.2/client/b6cb68afde1d9cf4a20cbf27fa90d0828bf440a4/client.jar",     ModernPatcher_ExtractFiles, 4621, false, 0 },
	{ "terrain.png patch", RESOURCE_SERVER "/terrain-patch2.png", TerrainPatcher_Process, 7, false, 0 },
	{ "gui.png patch",     RESOURCE_SERVER "/gui.png",            NewTextures_ExtractGui, 21, false, 0 },
	/* 0.0.23 textures */
	{ "0.0.23 gold",  "https://classic.minecraft.net/assets/textures/gold.png",      Classic0023Patcher_OldGoldBlock, 1, false, 0 },
	{ "0.0.23 ore",   "https://classic.minecraft.net/assets/textures/rock_gold.png", Classic0023Patcher_OldGoldOre,   1, false, 0 },
	{ "0.0.23 black", "https://classic.minecraft.net/assets/textures/color13.png",   Classic0023Patcher_OldBlackWool, 1, false, 0 },
	{ "0.0.23 gray",  "https://classic.minecraft.net/assets/textures/color14.png",   Classic0023Patcher_OldGrayWool,  1, false, 0 },
};
...
static const struct TilePatch { const char* name; cc_uint8 x1,y1, x2,y2; } modern_tiles[12] = {
	{ "assets/minecraft/textures/blocks/sandstone_bottom.png", 9,3, 0,0 },
	{ "assets/minecraft/textures/blocks/sandstone_normal.png", 9,2, 0,0 },
	{ "assets/minecraft/textures/blocks/sandstone_top.png", 9,1, 0,0 },
	{ "assets/minecraft/textures/blocks/quartz_block_lines_top.png", 10,3, 10,1 },
	{ "assets/minecraft/textures/blocks/quartz_block_lines.png", 10,2, 0,0 },
	{ "assets/minecraft/textures/blocks/stonebrick.png", 4,3, 0,0 },
	{ "assets/minecraft/textures/blocks/snow.png", 2,3, 0,0 },
	{ "assets/minecraft/textures/blocks/wool_colored_blue.png",  3,5, 0,0 },
	{ "assets/minecraft/textures/blocks/wool_colored_brown.png", 2,5, 0,0 },
	{ "assets/minecraft/textures/blocks/wool_colored_cyan.png",  4,5, 0,0 },
	{ "assets/minecraft/textures/blocks/wool_colored_green.png", 1,5, 0,0 },
	{ "assets/minecraft/textures/blocks/wool_colored_pink.png",  0,5, 0,0 }
};
