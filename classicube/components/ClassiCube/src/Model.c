...
static struct ModelTex human_tex = { "char.png", 0, 0, NULL };
static struct Model  human_model = { 
	...
	Model_GetTransform, Model_NullFunc, 0.0f, 0.0f, 0, NULL
};
...
static struct Model sitting_model = { "sit", human_vertices, &human_tex,
	...
	0, 0,0, 0, false, false, false, false, false,
	SittingModel_GetTransform, Model_NullFunc, 0.0f, 0.0f, 0, NULL
};
...
static struct Model head_model = { "head", human_vertices, &human_tex,
	...
	0, 0,0, 0, false, false, false, false, false,
	HeadModel_GetTransform, Model_NullFunc, 0.0f, 0.0f, 0, NULL
};
...
static struct ModelTex chicken_tex = { "chicken.png", 0, 0, NULL };
...
static struct ModelTex creeper_tex = { "creeper.png", 0, 0, NULL };
...
static struct ModelTex pig_tex = { "pig.png", 0, 0, NULL };
...
static struct ModelTex fur_tex = { "sheep_fur.png", 0, 0, NULL };
...
static struct ModelTex sheep_tex = { "sheep.png", 0, 0, NULL };
...
static struct ModelTex skeleton_tex = { "skeleton.png", 0, 0, NULL };
...
static struct ModelTex spider_tex = { "spider.png", 0, 0, NULL };
...
static struct ModelTex zombie_tex = { "zombie.png", 0, 0, NULL };
...
static struct ModelTex skinnedCube_tex = { "skinnedcube.png", 0, 0, NULL };
...
#ifdef CC_BUILD_RETROGO
	if (!Models_Ptr) {
		Models_Ptr = (struct _ModelsData*)rg_alloc(sizeof(struct _ModelsData), MEM_SLOW);
		Mem_Set(Models_Ptr, 0, sizeof(struct _ModelsData));
	}
#endif
	Models.MaxVertices = MODELS_MAX_VERTICES;
