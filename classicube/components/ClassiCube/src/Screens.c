...
static struct HUDScreen* HUDScreen_Ptr;
#define HUDScreen_Instance (*HUDScreen_Ptr)
#else
static struct HUDScreen HUDScreen_Instance_Data CC_BIG_VAR;
#define HUDScreen_Instance HUDScreen_Instance_Data
#endif
...
static void HUDScreen_BuildCrosshairsMesh(struct VertexTextured** ptr) {
	...
	static struct Texture tex = { 0, 0,0,0,0, {0.0f,0.0f, 15/256.0f,15/64.0f} };
	int extent;
...
#ifdef CC_BUILD_RETROGO
	if (!HUDScreen_Ptr) HUDScreen_Ptr = (struct HUDScreen*)rg_alloc(sizeof(struct HUDScreen), MEM_SLOW);
#endif
	struct HUDScreen* s = &HUDScreen_Instance;
...
#ifdef CC_BUILD_RETROGO
static struct TabListOverlay* TabListOverlay_Ptr;
#define TabListOverlay_Instance (*TabListOverlay_Ptr)
#else
static struct TabListOverlay TabListOverlay_Instance_Data CC_BIG_VAR;
#define TabListOverlay_Instance TabListOverlay_Instance_Data
#endif
...
#ifdef CC_BUILD_RETROGO
	if (!TabListOverlay_Ptr) TabListOverlay_Ptr = (struct TabListOverlay*)rg_alloc(sizeof(struct TabListOverlay), MEM_SLOW);
#endif
...
#ifdef CC_BUILD_RETROGO
static struct ChatScreen* ChatScreen_Ptr;
#define ChatScreen_Instance (*ChatScreen_Ptr)
#else
static struct ChatScreen ChatScreen_Instance_Data CC_BIG_VAR;
#define ChatScreen_Instance ChatScreen_Instance_Data
#endif
...
static void ChatScreen_EnterChatInput(struct ChatScreen* s, cc_bool close) {
	...
	input = &s->input.base;
	input->VTABLE->HandlesKeyDown(input, CCKEY_ENTER, NULL);
...
static void ChatScreen_ContextRecreated(void* screen) {
	...
	ButtonWidget_SetConst(&s->more,   "More",   &titleFont);
	ButtonWidget_SetConst(&s->send,   "Send",   &titleFont);
...
#ifdef CC_BUILD_RETROGO
	if (!ChatScreen_Ptr) ChatScreen_Ptr = (struct ChatScreen*)rg_alloc(sizeof(struct ChatScreen), MEM_SLOW);
#endif
...
#ifdef CC_BUILD_RETROGO
static struct SpecialTextScreen* SpecialTextScreen_Ptr;
#define SpecialTextScreen_Instance (*SpecialTextScreen_Ptr)
#else
static struct SpecialTextScreen SpecialTextScreen_Instance_Data CC_BIG_VAR;
#define SpecialTextScreen_Instance SpecialTextScreen_Instance_Data
#endif
...
#ifdef CC_BUILD_RETROGO
	if (!SpecialTextScreen_Ptr) SpecialTextScreen_Ptr = (struct SpecialTextScreen*)rg_alloc(sizeof(struct SpecialTextScreen), MEM_SLOW);
#endif
...
#ifdef CC_BUILD_RETROGO
static struct InventoryScreen* InventoryScreen_Ptr;
#define InventoryScreen_Instance (*InventoryScreen_Ptr)
#else
static struct InventoryScreen InventoryScreen_Data CC_BIG_VAR;
#define InventoryScreen_Instance InventoryScreen_Data
#endif
...
#ifdef CC_BUILD_RETROGO
	if (!InventoryScreen_Ptr) InventoryScreen_Ptr = (struct InventoryScreen*)rg_alloc(sizeof(struct InventoryScreen), MEM_SLOW);
#endif
...
#ifdef CC_BUILD_RETROGO
static struct LoadingScreen* LoadingScreen_Ptr;
#define LoadingScreen_Instance (*LoadingScreen_Ptr)
#else
static struct LoadingScreen LoadingScreen_Data CC_BIG_VAR;
#define LoadingScreen_Instance LoadingScreen_Data
#endif
...
#ifdef CC_BUILD_RETROGO
	if (!LoadingScreen_Ptr) LoadingScreen_Ptr = (struct LoadingScreen*)rg_alloc(sizeof(struct LoadingScreen), MEM_SLOW);
#endif
...
static void GeneratingScreen_AtlasChanged(void* obj) {
	LoadingScreen_Instance.dirty = true; /* Dirt texture may have changed */
}
...
#ifdef CC_BUILD_RETROGO
static struct DisconnectScreen* DisconnectScreen_Ptr;
#define DisconnectScreen_Instance (*DisconnectScreen_Ptr)
#else
static struct DisconnectScreen DisconnectScreen_Data CC_BIG_VAR;
#define DisconnectScreen_Instance DisconnectScreen_Data
#endif
...
#ifdef CC_BUILD_RETROGO
	if (!DisconnectScreen_Ptr) DisconnectScreen_Ptr = (struct DisconnectScreen*)rg_alloc(sizeof(struct DisconnectScreen), MEM_SLOW);
#endif
