...
static struct TextureEntry gui_entry = { "gui.png", GuiPngProcess, NULL };
...
static struct TextureEntry guiClassic_entry = { "gui_classic.png", GuiClassicPngProcess, NULL };
...
static struct TextureEntry icons_entry = { "icons.png", IconsPngProcess, NULL };
...
static struct TextureEntry touch_entry = { "touch.png", TouchPngProcess, NULL };
